...
**INSTRUCTIONS:  From an elevated prompt, change to your desired install directory and type/paste the following command:**
    ...
    PowerShell -executionpolicy bypass -command "Invoke-WebRequest https://github.com/mucifous/xWSL/raw/master/xWSL.cmd -UseBasicParsing -OutFile xWSL.cmd ; .\xWSL.cmd"
